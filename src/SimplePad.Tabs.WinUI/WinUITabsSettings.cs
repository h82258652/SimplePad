...
internal sealed class WinUITabsSettings : AppSettingsBase, ITabsSettings
{
    ...
    {
        return ApplicationData.GetDefault().LocalSettings.CreateContainer("Tabs", ApplicationDataCreateDisposition.Always).Values;
    }
}