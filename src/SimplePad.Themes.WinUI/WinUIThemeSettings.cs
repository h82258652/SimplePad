...
internal sealed class WinUIThemeSettings : AppSettingsBase, IThemeSettings
{
    ...
    {
        return ApplicationData.GetDefault().LocalSettings.CreateContainer("Themes", ApplicationDataCreateDisposition.Always).Values;
    }
}
