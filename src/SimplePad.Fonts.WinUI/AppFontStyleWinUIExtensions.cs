...
public static class AppFontStyleWinUIExtensions
{
    public static FontStyle GetWinUIFontStyle(this AppFontStyle fontStyle)
    {
    ...
    public static FontWeight GetWinUIFontWeight(this AppFontStyle fontStyle)
    {
