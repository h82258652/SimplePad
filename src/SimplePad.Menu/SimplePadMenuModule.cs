            ...
            context.Services.Configure<MenuBarOptions>(options =>
            {
                ...
                options.ViewItems.AddRange(
                    new MenuItemGroup("Zoom")
                    {
                        ...
                        [
                            ...
                            new MenuItem(
                                ...
                                {
                                    serviceProvider
                                        .GetRequiredService<EditorZoomState>()
                                        .ResetZoomFactor();
                                }
                            ),
                        ],
                    ...
                    new ToggleMenuItem(
                        ...
                        (serviceProvider) =>
                        {
                            return serviceProvider
                                .GetRequiredService<IStatusBarSettings>()
                                .IsStatusBarVisible;
                        },
                    ...
                    new ToggleMenuItem(
                        ...
                        (serviceProvider, isChecked) =>
                        {
                            serviceProvider.GetRequiredService<IEditorSettings>().IsWordWrap =
                                isChecked;
                        }
                    )
                );
